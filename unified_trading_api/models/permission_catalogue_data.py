...
for _venue in sorted(
    ...
    _VENUE_PERMS.append(
        _perm(
            ...
            "venues",
            _venue,
            _venue.replace("_", " ").title(),
            f"Access {_venue} data",
        )
    )
...
_EXECUTION_GATE_PERMS = [
    ...
    _perm(
        ...
        "venue_execution",
        "Venue Execution",
        "Per-venue execution permission",
    ),
]
...
_REPORTING_DOMAIN = DomainNode(
    ...
    categories=[
        ...
        _cat(
            ...
            "regulatory",
            "Regulatory",
            "Regulatory and executive reports",
...
_ORG_SCOPING_PERMS = [
    _perm(
        ...
        "Organisation subscription tier ceiling",
    ),
...
_FEATURE_SUBSCRIPTIONS_DOMAIN = DomainNode(
    ...
    categories=[
        _cat(
            ...
            "entitlements",
            "Entitlements",
            "UAC entitlement gates (from rbac.py)",
            _ENTITLEMENT_PERMS,
        ),
        _cat(
            _D.FEATURE_SUBSCRIPTIONS,
